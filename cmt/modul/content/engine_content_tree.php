...
if (isset($id_parent)) cross_table('id_parent', $id_parent);
else cross_table('id_parent');
...
$formdata['title_sub'] = array	(
	'type'				=>	'text',
	'label'				=>	v('CMT_TITLE_SUB'),
	'style'					=>	array(
		'class'				=>	"col-3_of_7"
	)
);
...
$formdata['addition'] = array	(
	'type'				=>	'textarea',
	'label'				=>	v('CMT_ADDITION')
);

$formdata['description'] = array	(
	'type'				=>	'textarea',
	'label'				=>	v('CMT_DESCRIPTION')
);
...
$formdata['c_top'] = array	(
	'type'						=>	'checkbox',
	'label'						=>  v('CMT_POSITION'),
	'parent_class'		=>	'multi_checkbox',
	'settings'				=>	array(
		'data'					=>	array('1' => v('CMT_TOP'))
	)
);

$formdata['c_right'] = array	(
	'type'						=>	'checkbox',
	'parent_class'		=>	'multi_checkbox',
	'settings'				=>	array(
		'data'					=>	array('1' => v('CMT_RIGHT'))
	)
);

$formdata['c_bottom'] = array	(
	'type'						=>	'checkbox',
	'parent_class'		=>	'multi_checkbox',
	'settings'				=>	array(
		'data'					=>	array('1' => v('CMT_BOTTOM'))
	)
);

$formdata['c_left'] = array	(
	'type'						=>	'checkbox',
	'parent_class'		=>	'multi_checkbox',
	'settings'				=>	array(
		'data'					=>	array('1' => v('CMT_LEFT'))
	)
);

$formdata['c_top_2'] = array	(
	'type'						=>	'checkbox',
	'parent_class'		=>	'multi_checkbox',
	'settings'				=>	array(
		'data'					=>	array('1' => v('CMT_TOP')." 2")
	)
);

$formdata['c_right_2'] = array	(
	'type'						=>	'checkbox',
	'parent_class'		=>	'multi_checkbox',
	'settings'				=>	array(
		'data'					=>	array('1' => v('CMT_RIGHT')." 2")
	)
);

$formdata['c_bottom_2'] = array	(
	'type'						=>	'checkbox',
	'parent_class'		=>	'multi_checkbox',
	'settings'				=>	array(
		'data'					=>	array('1' => v('CMT_BOTTOM')." 2")
	)
);

$formdata['c_left_2'] = array	(
	'type'						=>	'checkbox',
	'parent_class'		=>	'multi_checkbox',
	'settings'				=>	array(
		'data'					=>	array('1' => v('CMT_LEFT')." 2")
	)
);
